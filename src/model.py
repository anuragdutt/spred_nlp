...
if __name__ == "__main__":
	...
	print("mlp.......................................................")
	model_dict["mlp"] = mlp.fit([docs_train,X_train],y_train,batch_size=8,epochs=25,verbose=1) 
	...
	print("rnn.......................................................")
	model_dict["rnn"] = rnn.fit([docs_train,X_train],y_train,batch_size=8,epochs=25,verbose=1)
	...
	print("cnn.......................................................")
	model_dict["cnn"] = cnn.fit([docs_train,X_train],y_train,batch_size=8,epochs=25,verbose=1)
	...
	print("rnn_cnn.......................................................")
	model_dict["rnn_cnn"] = rnn_cnn.fit([docs_train,X_train],y_train,batch_size=8,epochs=25,verbose=1)
